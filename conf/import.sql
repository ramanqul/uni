...
create table courses(couse_id bigint not null auto_increment primary key, name varchar(256) not null);
...
create table catalogs(catalog_id bigint not null auto_increment primary key, credits int not null,subject_id bigint not null, faculty_id bigint not null);
